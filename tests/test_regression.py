...
import time
from pssvi.model import MarkovGP
from pssvi.kernels import Matern32
from pssvi.likelihoods import Gaussian
...
kern = Matern32(variance=var_f, lengthscale=len_f)
lik = Gaussian(variance=var_y)
model = MarkovGP(kernel=kern, likelihood=lik, X=x, Y=y)
